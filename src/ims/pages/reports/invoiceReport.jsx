...
const InvoiceReport = () => {
  ...
  const handlePrint = () => {
    ...
    <div style="padding: 20px;">
      <h2 style="text-align: center; margin-bottom: 20px; color: #333;">Invoice Report</h2>
      ${tableContent}
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      ...
      <div className="flex justify-between items-center mb-6 flex-wrap gap-3">
        <div>
          <h2 className="text-xl font-semibold text-gray-800">Invoice Report</h2>
          <p className="text-sm text-gray-500">Manage your Invoice Report</p>
        </div>
