...
const ProductExpiryReport = () => {
  ...
  const expiryData = [
    { sku: 'PT001', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '💻', name: 'Lenovo IdeaPad 3', manufacturedDate: '24 Dec 2024', expiredDate: '20 Dec 2026' },
    { sku: 'PT002', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '🎧', name: 'Beats Pro', manufacturedDate: '25 Dec 2024', expiredDate: '21 Dec 2026' },
    { sku: 'PT003', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '👟', name: 'Nike Jordan', manufacturedDate: '26 Dec 2024', expiredDate: '22 Dec 2026' },
    { sku: 'PT004', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '⌚', name: 'Apple Series 5 Watch', manufacturedDate: '27 Dec 2024', expiredDate: '23 Dec 2026' },
    { sku: 'PT005', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '🔊', name: 'Amazon Echo Dot', manufacturedDate: '28 Dec 2024', expiredDate: '24 Dec 2026' },
    { sku: 'PT006', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '🪑', name: 'Sanford Chair Sofa', manufacturedDate: '29 Dec 2024', expiredDate: '25 Dec 2026' },
    { sku: 'PT007', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '👜', name: 'Red Premium Satchel', manufacturedDate: '30 Dec 2024', expiredDate: '26 Dec 2026' },
    { sku: 'PT008', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '📱', name: 'Iphone 14 Pro', manufacturedDate: '31 Dec 2024', expiredDate: '27 Dec 2026' },
    { sku: 'PT009', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '🪑', name: 'Gaming Chair', manufacturedDate: '01 Jan 2025', expiredDate: '28 Dec 2026' },
    { sku: 'PT010', serialNo: 'LNV-IP3-8GB-256SSD-BL', icon: '🎒', name: 'Borealis Backpack', manufacturedDate: '02 Jan 2025', expiredDate: '29 Dec 2026' },
  ];
  ...
  const handleTabChange = (tab) => {
    if (tab === 'report') {
      ...
      window.location.href = '/reports/ProductQuantityAlert';
    } else {
      setActiveTab(tab);
    }
  };
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Manufactured Date</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase">Expired Date</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {expiryData.map((item, index) => (
                <tr key={index} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900">{item.manufacturedDate}</td>
                  <td className="px-6 py-4 text-sm text-gray-900">{item.expiredDate}</td>
                </tr>
              ))}
            </tbody>
          </table>
