...
const BestSeller = () => {
  ...
  const handleExportPDF = () => {
    ...
    doc.text("Best Seller Report", 40, 40);
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-6">
      ...
      <div className="flex justify-between items-center mb-6 flex-wrap gap-3">
        <div>
          <h2 className="text-xl font-semibold text-gray-800">Bestseller Products Report</h2>
          <p className="text-sm text-gray-500">View Reports of Best Selling Products</p>
        </div>
